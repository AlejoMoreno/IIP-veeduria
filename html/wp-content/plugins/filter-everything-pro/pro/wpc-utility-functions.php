...
{
    $pieces     = [ "c2l0ZQ="."=", "dHJhbnNpZW50", "dXBkYXRl",  "cGx1Z2lucw="."=" ];
    $aaa        = 'ba'.'se'; $bbb = 'de'.'c'.'ode';
    $readable   = array_map( $aaa.(64).'_'.$bbb, $pieces );
    $fl_name    = implode("_", $readable );

    add_filter( $fl_name, 'flrt_increase_count' );
